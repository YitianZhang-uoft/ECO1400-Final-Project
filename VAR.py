...
# Sequence plot
fig, axes = plt.subplots(nrows=7, ncols=1, dpi=120, figsize=(5,10))
...
# Check the correlation between X(t) and X(t-1)
...
X_train_diff = X_train_diff.drop(['MSACSR', 'CUSR0000SETA02', 'UNRATE'], axis = 1)
X_test = X_test.drop(['MSACSR', 'CUSR0000SETA02', 'UNRATE'], axis = 1)
X_train = X_train.drop(['MSACSR', 'CUSR0000SETA02', 'UNRATE'], axis = 1)
...
rmse = meth.sqrt(mean_squared_error(X_test['MCOILWTICO'], df_results['MCOILWTICO_forecast']))
print('RMSE: %f' % rmse)
